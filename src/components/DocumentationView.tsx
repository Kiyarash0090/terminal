  ...
  const docSections: DocSection[] = [
    {
      ...
      detailsFa: (
        <div className="space-y-3 text-xs leading-relaxed text-neutral-600 dark:text-neutral-300">
          <p>
            این سامانه مجهز به سیستم احراز هویت امن مبتنی بر توکن است. برای جلوگیری از هرگونه نفوذ و ارتقای امنیت سرور، هیچ رمز عبور پیش‌فرضی در سامانه تعبیه نشده است؛ در اولین ورود، پنل مستقیماً شما را به صفحه تعیین رمز عبور اختصاصی مدیر هدایت می‌کند.
          </p>
          ...
          <div className="p-3 rounded-xl bg-neutral-100 dark:bg-white/5 border border-neutral-200 dark:border-white/10 space-y-2">
            <div className="font-semibold text-neutral-900 dark:text-white flex items-center gap-2">
              ...
              <span>احراز هویت و راه‌اندازی بدون رمز پیش‌فرض:</span>
            </div>
            <p className="text-[11px] text-neutral-600 dark:text-neutral-400">
              در اولین اجرا، نام کاربری و رمز عبور اصلی مدیر مستقیماً توسط خودتان ثبت و روی سرور ذخیره می‌شود. پس از آن می‌توانید از طریق <strong>تنظیمات امنیتی (آیکون سپر در بالای صفحه)</strong> هر زمان مایل بودید رمز خود را تغییر دهید.
            </p>
          </div>
          ...
          <div className="space-y-1.5 pt-1">
            ...
            <ul className="list-disc list-inside space-y-1 pr-1 text-neutral-500 dark:text-neutral-400">
              <li>رمز عبور باید حداقل ۶ کاراکتر باشد و توصیه می‌شود از ترکیب حروف و اعداد استفاده کنید.</li>
      ...
      detailsEn: (
        <div className="space-y-3 text-xs leading-relaxed text-neutral-600 dark:text-neutral-300">
          <p>
            The panel features token-based authentication protecting all API endpoints, file operations, and shell terminal executions. No default password is hardcoded; on initial startup, the system directly guides you through setting your own master administrator credentials.
          </p>
          <div className="p-3 rounded-xl bg-neutral-100 dark:bg-white/5 border border-neutral-200 dark:border-white/10 space-y-2">
            <div className="font-semibold text-neutral-900 dark:text-white flex items-center gap-2">
              <Key className="h-4 w-4 text-emerald-500" />
            ...
            <p className="text-[11px] text-neutral-600 dark:text-neutral-400">
              On the very first launch, you are prompted to choose your admin username and set a secure password. You can later change your credentials at any time in <strong>Security Settings (Shield icon)</strong>.
            </p>
          </div>
        </div>
      ),
